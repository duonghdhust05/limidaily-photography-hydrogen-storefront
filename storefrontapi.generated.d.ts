...
export type GetBlogArticlesQueryVariables = StorefrontAPI.Exact<{
  blogHandle: StorefrontAPI.Scalars['String']['input'];
  n: StorefrontAPI.Scalars['Int']['input'];
}>;
...
export type GetCollectionByHandleQueryVariables = StorefrontAPI.Exact<{
  ...
  n?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['Int']['input']>;
}>;
...
export type GetProductDetailsWithVariantsQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  m: StorefrontAPI.Scalars['Int']['input'];
}>;

export type GetProductDetailsWithVariantsQuery = {
...
export type GetProductWithMetafieldsQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
}>;

export type GetProductWithMetafieldsQuery = {
  product?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
      technicalSpecs?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value' | 'type'>
      >;
      packageContents?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value' | 'type'>
      >;
      compatibility?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value' | 'type'>
      >;
    }
  >;
...
export type GetProductsWithVariantsQueryVariables = StorefrontAPI.Exact<{
  n: StorefrontAPI.Scalars['Int']['input'];
  m: StorefrontAPI.Scalars['Int']['input'];
}>;

export type GetProductsWithVariantsQuery = {
  products: {
    edges: Array<{
      node: Pick<
        StorefrontAPI.Product,
...
export type GetProductsWithCursorPaginationQueryVariables =
  StorefrontAPI.Exact<{
    first: StorefrontAPI.Scalars['Int']['input'];
    after?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['String']['input']>;
  }>;

export type GetProductsWithCursorPaginationQuery = {
  products: {
    edges: Array<
...
export type GetShopAndLocalizationQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type GetShopAndLocalizationQuery = {
  shop: Pick<
    StorefrontAPI.Shop,
    'name' | 'description' | 'moneyFormat' | 'shipsToCountries'
  ...
  localization: {
    ...
    availableLanguages: Array<Pick<StorefrontAPI.Language, 'isoCode' | 'name'>>;
  };
};

export type GetShopInVietnamContextQueryVariables = StorefrontAPI.Exact<{
  n: StorefrontAPI.Scalars['Int']['input'];
}>;

export type GetShopInVietnamContextQuery = {
  localization: {
    country: Pick<StorefrontAPI.Country, 'isoCode' | 'name'> & {
      currency: Pick<StorefrontAPI.Currency, 'isoCode' | 'name' | 'symbol'>;
    };
  ...
  products: {
    edges: Array<{
      node: Pick<StorefrontAPI.Product, 'title'> & {
        priceRange: {
          minVariantPrice: Pick<
            StorefrontAPI.MoneyV2,
            'amount' | 'currencyCode'
...
export type SidebarQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;
...
export type HomepageDataQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;
...
> & {
  ...
  technicalSpecs?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  packageContents?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  compatibility?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  options: Array<
...
interface GeneratedQueryTypes {
  '#graphql\n  query GetBlogArticles($blogHandle: String!, $n: Int!) {\n    blog(handle: $blogHandle) {\n      id\n      title\n      articles(first: $n) {\n        edges {\n          node {\n            id\n            title\n            handle\n            excerpt\n            contentHtml\n            publishedAt\n            authorV2 {\n              name\n            }\n            image {\n              url\n              altText\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: GetBlogArticlesQuery;
    variables: GetBlogArticlesQueryVariables;
  };
  ...
  '#graphql\n  query GetProductDetailsWithVariants($handle: String!, $m: Int!) {\n    product(handle: $handle) {\n      id\n      title\n      handle\n      descriptionHtml\n      vendor\n      options {\n        id\n        name\n        optionValues {\n          id\n          name\n        }\n      }\n      variants(first: $m) {\n        edges {\n          node {\n            id\n            title\n            sku\n            availableForSale\n            selectedOptions {\n              name\n              value\n            }\n            price {\n              amount\n              currencyCode\n            }\n            compareAtPrice {\n              amount\n              currencyCode\n            }\n            image {\n              url\n              altText\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: GetProductDetailsWithVariantsQuery;
    variables: GetProductDetailsWithVariantsQueryVariables;
  };
  '#graphql\n  query GetProductWithMetafields($handle: String!) {\n    product(handle: $handle) {\n      id\n      title\n      handle\n      technicalSpecs: metafield(namespace: "custom", key: "technical_specifications") {\n        value\n        type\n      }\n      packageContents: metafield(namespace: "custom", key: "package_contents") {\n        value\n        type\n      }\n      compatibility: metafield(namespace: "custom", key: "compatibility") {\n        value\n        type\n      }\n    }\n  }\n': {
    return: GetProductWithMetafieldsQuery;
    variables: GetProductWithMetafieldsQueryVariables;
  };
  '#graphql\n  query GetProductsWithVariants($n: Int!, $m: Int!) {\n    products(first: $n) {\n      edges {\n        node {\n          id\n          title\n          handle\n          description\n          priceRange {\n            minVariantPrice {\n              amount\n              currencyCode\n            }\n            maxVariantPrice {\n              amount\n              currencyCode\n            }\n          }\n          featuredImage {\n            url\n            altText\n            width\n            height\n          }\n          variants(first: $m) {\n            edges {\n              node {\n                id\n                title\n                availableForSale\n                price {\n                  amount\n                  currencyCode\n                }\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: GetProductsWithVariantsQuery;
    variables: GetProductsWithVariantsQueryVariables;
  };
  '#graphql\n  query GetProductsWithCursorPagination($first: Int!, $after: String) {\n    products(first: $first, after: $after) {\n      edges {\n        cursor\n        node {\n          id\n          title\n          handle\n        }\n      }\n      pageInfo {\n        hasNextPage\n        hasPreviousPage\n        startCursor\n        endCursor\n      }\n    }\n  }\n': {
    return: GetProductsWithCursorPaginationQuery;
    variables: GetProductsWithCursorPaginationQueryVariables;
  };
  '#graphql\n  query GetShopAndLocalization {\n    shop {\n      name\n      description\n      primaryDomain {\n        url\n        host\n      }\n      moneyFormat\n      shipsToCountries\n    }\n    localization {\n      country {\n        isoCode\n        name\n        currency {\n          isoCode\n          name\n          symbol\n        }\n      }\n      availableCountries {\n        isoCode\n        name\n        currency {\n          isoCode\n          name\n          symbol\n        }\n      }\n      language {\n        isoCode\n        name\n      }\n      availableLanguages {\n        isoCode\n        name\n      }\n    }\n  }\n': {
    return: GetShopAndLocalizationQuery;
    variables: GetShopAndLocalizationQueryVariables;
  };
  '#graphql\n  query GetShopInVietnamContext($n: Int!) @inContext(country: VN, language: VI) {\n    localization {\n      country {\n        isoCode\n        name\n        currency {\n          isoCode\n          name\n          symbol\n        }\n      }\n    }\n    products(first: $n) {\n      edges {\n        node {\n          title\n          priceRange {\n            minVariantPrice {\n              amount\n              currencyCode\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: GetShopInVietnamContextQuery;
    variables: GetShopInVietnamContextQueryVariables;
  };
  ...
  '#graphql\n  fragment FeaturedCollectionItem on Collection {\n    id\n    title\n    description\n    image {\n      id\n      url\n      altText\n      width\n      height\n    }\n    handle\n  }\n  query HomepageData($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    shop {\n      name\n      description\n    }\n    collections(first: 10, sortKey: UPDATED_AT) {\n      nodes {\n        ...FeaturedCollectionItem\n      }\n    }\n  }\n': {
    return: HomepageDataQuery;
    variables: HomepageDataQueryVariables;
  };
